(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [19642],
  {
      ...
      t.exports.L = function (t) {
        return l({
          ...
          child: [
            {
              tag: "path",
              attr: { fillRule: "evenodd", d: "M256 48l240 416H16z" },
            },
          ],
        })(t);
      };
    },
    67553: function (t, a, c) {
      var l = c(15787).w_;
    ...
    17037: function (t, a, c) {
      ...
      var l = c(67294);
      let r = (t) => "function" == typeof t,
        i = { any: 0, all: 1 };
      function e(t, { root: a, margin: c, amount: e, once: h = !1 } = {}) {
        let [n, o] = (0, l.useState)(!1);
        return (
          (0, l.useEffect)(() => {
            if (!t.current || (h && n)) return;
            let l = () => (o(!0), h ? void 0 : () => o(!1)),
              v = {
            ...
            return (function (
              ...
              let v =
                  ("string" == typeof (h = t)
                    ? n
                      ? ((null !== (o = n[h]) && void 0 !== o) ||
                          (n[h] = document.querySelectorAll(h)),
                        (h = n[h]))
                      : (h = document.querySelectorAll(h))
                    : h instanceof Element && (h = [h]),
                  Array.from(h || [])),
                z = new WeakMap(),
                g = (t) => {
                  t.forEach((t) => {
                    let c = z.get(t.target);
                    if (t.isIntersecting !== Boolean(c)) {
                      if (t.isIntersecting) {
                        let l = a(t);
                        r(l) ? z.set(t.target, l) : u.unobserve(t.target);
                      } else c && (c(t), z.delete(t.target));
                    }
                  });
                },
                u = new IntersectionObserver(g, {
                  root: c,
                  rootMargin: l,
                  threshold: "number" == typeof e ? e : i[e],
                });
              return v.forEach((t) => u.observe(t)), () => u.disconnect();
            })(t.current, l, v);
          }, [a, t, c, h]),
          n
        );
...
//# sourceMappingURL=19642-1be408051a3db372.js.map

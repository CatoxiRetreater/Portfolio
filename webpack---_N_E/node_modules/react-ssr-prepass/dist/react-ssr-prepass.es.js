...
function useMemo(e, r) {
  ...
  if (null !== n && null !== t) {
    if (
      (function areHookInputsEqual(e, r) {
        if (null === r) {
          return !1;
        }
...
var resolve = function (e) {
  ...
  r._status = 0;
  return (r._result = (r._ctor || r._result)()
    .then(function (e) {
      r._result = e;
...
var render = function (e, r, t, n, u) {
  return (o = e).prototype && o.prototype.isReactComponent
    ? (function (e, r, t, n, u) {
  ...
  switch (
    ...
    case M:
      ...
      if ("function" == typeof a) {
        var i = e.type;
        var c = readContextValue(
          "object" == typeof i._context ? i._context : i
        );
        ...
        u = (function (e, r) {
          ...
          if (r.error) {
            ...
            if ("function" == typeof r.type.getDerivedStateFromError) {
              r.instance.updater.enqueueSetState(
                r.instance,
                r.type.getDerivedStateFromError(r.error)
              );
            }
          }
...
var flushFrames = function (e, r, t) {
  ...
  return Promise.resolve(n.thenable).then(
    function () {
      !(function (e) {
        O.current = e;
      })(t);

...
function ee(r, e) {
  let s = A(r),
    ...
    D = he(),
    b = y((l, i = g.Hidden) => {
      let t = n.current.findIndex(({ el: o }) => o === l);
      t !== -1 &&
        (R(i, {
          [g.Unmount]() {
    ...
    S = c([]),
    u = c(Promise.resolve()),
    p = c({ enter: [], leave: [], idle: [] }),
    d = y((l, i, t) => {
      S.current.splice(0),
        e &&
          (e.chains.current[i] = e.chains.current[i].filter(([o]) => o !== l)),
        e == null ||
          e.chains.current[i].push([
            l,
            new Promise((o) => {
              S.current.push(o);
            }),
        ...
        i === "enter"
          ? (u.current = u.current
              .then(() => (e == null ? void 0 : e.wait.current))
              .then(() => t(i)))
          : t(i);
    }),
    h = y((l, i, t) => {
      Promise.all(p.current[i].splice(0).map(([o, f]) => f))
        .then(() => {
          var o;
...
let xe = "div",
  ...
  re = W(function (e, s) {
    let {
      ...
      { show: a, appear: P, initial: ie } = Ce(),
      [v, _] = B(a ? "visible" : "hidden"),
      z = ge(),
      { register: N, unregister: V } = z,
      j = c(null);
    H(() => N(t), [N, t]),
      H(() => {
        if (f === g.Hidden && !!t.current) {
          ...
          return R(v, { ["hidden"]: () => V(t), ["visible"]: () => N(t) });
        }
      }, [v, t, N, V, a, f]);
    let oe = A({
        enter: x(E),
      ...
      L = Se({ beforeEnter: n, afterEnter: m, beforeLeave: D, afterLeave: b }),
      U = Z();
    H(() => {
      if (U && v === "visible" && t.current === null)
        throw new Error(
    ...
    let k = ie && !P,
      se = (() =>
        !U || k || j.current === a ? "idle" : a ? "enter" : "leave")(),
      le = y((C) =>
        R(C, {
    ...
    return T.createElement(
      ...
      T.createElement(
        Te,
        { value: R(v, { ["visible"]: O.Open, ["hidden"]: O.Closed }) },
        X({
          ourProps: de,
          theirProps: ue,
          defaultTag: xe,
  ...
  q = W(function (e, s) {
    let { show: n, appear: m = !1, unmount: D, ...b } = e,
      E = c(null),
      S = $(E, s);
    Z();
    let u = Y();
    ...
    me(() => {
      l !== !1 &&
        ...
        (t.current.push(n), i(!1));
    }, [t, n]);
    let o = Q(() => ({ show: n, appear: m, initial: l }), [n, m, l]);
    H(() => {
      if (n) d("visible");
      else if (!I(h)) d("hidden");
      else {
        let a = E.current;
        if (!a) return;
      ...
      T.createElement(
        ...
        X({
          ourProps: {
            ...f,
            as: J,
            children: T.createElement(re, { ref: S, ...f, ...b }),
          },
          theirProps: {},
          defaultTag: J,
          features: ne,
  ...
  Pe = W(function (e, s) {
    ...
    return T.createElement(
      ...
      null,
      !n && m
        ? T.createElement(q, { ref: s, ...e })
        : T.createElement(re, { ref: s, ...e })
    );
  }),
  We = Object.assign(q, { Child: Pe, Root: q });
export { We as Transition };

...
function J(b) {
  let [t, o] = G(null),
    ...
    [a, s] = I(),
    u = S(
      () => ({ switch: t, setSwitch: o, labelledby: i, describedby: a }),
      [t, o, i, a]
    ),
    p = {},
    m = b;
  return l.createElement(
    ...
    l.createElement(
      ...
      l.createElement(
        h.Provider,
        { value: u },
        E({ ourProps: p, theirProps: m, defaultTag: z, name: "Switch.Group" })
      )
    )
  );
}
let Q = "button",
  V = K(function (t, o) {
    ...
    return l.createElement(
      ...
      E({ ourProps: D, theirProps: p, slot: C, defaultTag: Q, name: "Switch" })
    );
  }),
  be = Object.assign(V, { Group: J, Label: _, Description: B });
export { be as Switch };

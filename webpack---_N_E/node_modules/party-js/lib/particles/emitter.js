...
var Emitter = /** @class */ (function () {
  ...
  function Emitter(options) {
    ...
    this.options = config_1.overrideDefaults(
      options_1.getDefaultEmitterOptions(),
      options === null || options === void 0 ? void 0 : options.emitterOptions
    );
    this.emission = config_1.overrideDefaults(
      options_1.getDefaultEmissionOptions(),
      options === null || options === void 0 ? void 0 : options.emissionOptions
    );
    this.renderer = config_1.overrideDefaults(
      options_1.getDefaultRendererOptions(),
      options === null || options === void 0 ? void 0 : options.rendererOptions
    );
  }
  ...
  Emitter.prototype.tick = function (delta) {
    ...
    var _loop_1 = function (i) {
      ...
      if (
        this_1.options.despawningRules.some(function (rule) {
  ...
  Emitter.prototype.tickParticle = function (particle, delta) {
    ...
    if (this.options.useGravity) {
      ...
      particle.velocity = particle.velocity.add(
        vector_1.Vector.up.scale(settings_1.settings.gravity * delta)
      );
    }
  ...
  Emitter.prototype.emitParticle = function () {
    var particle = new particle_1.Particle({
      ...
      velocity: vector_1.Vector.from2dAngle(
        variation_1.evaluateVariation(this.emission.angle)
      ).scale(variation_1.evaluateVariation(this.emission.initialSpeed)),

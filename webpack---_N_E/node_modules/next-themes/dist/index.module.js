    ...
    ({
      ...
      const u = "system" === s,
        ...
        v = t
          ? `!function(){${h}${$(t)}}()`
          : o
          ? `!function(){try{${h}var e=localStorage.getItem('${n}');if('system'===e||(!e&&${u})){var t='${i}',m=window.matchMedia(t);if(m.media!==t||m.matches){${$(
              "dark"
      ...
      /*#__PURE__*/ return e.createElement("script", {
        nonce: d,
